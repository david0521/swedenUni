...
export default {
    ...
    methods: {
        ...
        async registerUni() {
            try {
                const userId = localStorage.getItem('userId');
                const response = await axios.post(`http://localhost:3000/api/users/modify/${userId}/university`, {
        ...
        async registerProgram() {
            try {
                const userId = localStorage.getItem('userId');
                const response = await axios.post(`http://localhost:3000/api/users/modify/${userId}/program`, {

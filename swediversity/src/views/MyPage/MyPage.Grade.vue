    ...
    methods: {
        async changeMerit() {
            try {
                ...
                const response = await axios.post(`http://51.13.63.57/api/users/modify/${userId}/meritPoint`, {
        ...
        async changePrerequisite() {
            try {
                ...
                const userId = localStorage.getItem('userId');
                const response = await axios.post(`http://51.13.63.57/api/users/modify/${userId}/prerequisites`, {

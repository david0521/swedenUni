    ...
    methods: {
        async changeMerit() {
            try {
                ...
                const response = await axios.post(`http://localhost:3000/api/users/modify/${userId}/meritPoint`, {
        ...
        async changePrerequisite() {
            try {
                ...
                const userId = localStorage.getItem('userId');
                const response = await axios.post(`http://localhost:3000/api/users/modify/${userId}/prerequisites`, {

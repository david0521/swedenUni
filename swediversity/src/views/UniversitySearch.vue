        ...
        async like(index) {
            try {
                ...
                if (currentLikeStatus) {
                    response = axios.delete(`https://swediversity.norwayeast.cloudapp.azure.com/api/users/${userId}/universities`, 
                        {
                            data: {
                    ...
                    response = axios.post(`https://swediversity.norwayeast.cloudapp.azure.com/api/users/${userId}/universities`, {
                        universities: universityId
                    })

    ...
    methods: {
      ...
      async getTuitionFee() {
        try {
            ...
            const response = await axios.get(`http://51.13.63.57/api/programs/name/${programName}`);
      ...
      async getExchange() {
        try {
            const response = await axios.get(`http://51.13.63.57/api/records/exchange-rate`);
